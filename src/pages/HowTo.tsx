    ...
    <div className="p-12">
      ...
      <div className="pb-8">
        ...
        <p>
          ...
          There are 5 categories, and a card from each category will be randomly
        ...
        <p>
          ...
          while others may include specific facial hair or patterns you can draw
          on your animal
        </p>
      </div>
      <div className="pb-8">
        ...
        <p>
          ...
          selected, players are taken to the game page. One of each of the 5
          category cards is displayed and flipped to show the 5 drawing topics.
          If a timed game mode was selected, a timer will display and begin to
          count down. At this point it's time to draw! Use your imagination and
      ...
      <p>
        ...
        simple. There are dozens of animals, habiats, and details for each of
        the category cards. See how many different combinations you can get. We
        bet you'll never get the same drawing twice!
      </p>
    </div>
  );
};
